-- EMERGENCY FIX: Create authenticate_staff_user function with proper permissions
...
-- Create the function with explicit permissions
...
SELECT proname, pronargs, prorettype::regtype FROM pg_proc WHERE proname = 'authenticate_staff_user';
